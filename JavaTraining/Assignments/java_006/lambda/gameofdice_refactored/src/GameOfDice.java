	...
	public static void main(String[] args) {
		...
		if (!(userChoice.equalsIgnoreCase("Q"))) {
			do {
				...
				userDie1 = 1 + (int)(Math.random() * ((6-1) + 1));
				userDie2 = 1 + (int)(Math.random() * ((6-1) + 1));
				
				compDie1 = 1 + (int)(Math.random() * ((6-1) + 1));
				compDie2 = 1 + (int)(Math.random() * ((6-1) + 1));
				System.out.println("You have rolled a " + userDie1 + " and " + userDie2 + " > the " + diceLabels[userDie1-1][userDie2-1]);
				System.out.println("I have rolled a " + compDie1 + " and " + compDie2 + " > the " + diceLabels[compDie1-1][compDie2-1]);
